...
from collector.scraper import main as scraper
...
MAX_INPUT_TEXT_LENGTH = 1024
def get_scraper_data(task_name="T2TT", input_text="https://orientaldaily.on.cc/", source_language="yue", target_language="eng"):
    data = scraper.get_data(input_text)
    while len(data) > MAX_INPUT_TEXT_LENGTH:
        data = data[:MAX_INPUT_TEXT_LENGTH]
    translator.predict(task_name=task_name, input_text=data, source_language=source_language, target_language=target_language)
    return data
